...
*/
Request.form = function (value) {
    var request = new Request();
    if (value instanceof jQuery) {
        request.setForm(value);
    } else {
        request.setFormId(value);
    }
    return request;
};
...
Request.prototype = {
    ...
    */
    preloaderSelector: "#ajaxLoader",

    /**
    * HTML Form to be submitted by Ajax
    * It is possible to submit only one form per request
    */
    currentForm: null,
