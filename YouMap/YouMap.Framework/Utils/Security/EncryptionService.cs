...
namespace YouMap.Framework.Utils.Security
{
    ...
    {
        // Change these keys
        private readonly byte[] Key = { 12, 19, 19, 19, 24, 24, 81, 42, 119, 121, 28, 164, 47, 212, 122, 219, 251, 44, 8, 4, 17, 3, 96, 19, 24, 26, 17, 228, 131, 236, 33, 109 };
        private readonly byte[] Vector = { 14, 64, 11, 11, 2, 33, 13, 19, 21, 11, 221, 11, 79, 32, 14, 156 };
        ...
        {
            return DecryptString(encodedData);
        }
